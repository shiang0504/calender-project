...
const submitHandler = (event) => {
    ...
    if(contant.value.trim())todos.push(todo) //防空白
    ...
    <div class="todolistWrap" v-if="showWrap" :class="{show: listToggle}">
        ...
        <div class="section" @touchstart="touchstartHandler" @touchend="touchendHandler">
            ...
            <form @submit.prevent="submitHandler">
                <div class="inputBox">
                    <input autofocus @vnode-mounted="({ el }) => el.focus()" type="text" name="contant" id="contant" v-model="contant">
                    <label>請輸入待辦事項</label>
                </div>
                <div class="options">
                    <label for="category1">
                        ...
                        <div><i class="fa-solid fa-tag"></i>家庭</div>
                    </label>
                    <label for="category2">
        ...
        <div class="todolist">
            ...
            <div v-if="todo.show">
                ...
                <input type="text" :class="{ business: checkCategory(todo.category) }" v-model="todo.contant">
                <button class="edit" @click="editCategory(todo)"><i class="fa-solid fa-tag"></i></button>
